...
public class SteeringAssemblyController : MonoBehaviour
{
    ...
    /// <summary>
    /// Read by GarageDoorController to gate door opening.
    /// Set to true externally by CarAssemblyManager once SteeringSnapSetup
    /// reports AllPartsFullySnapped.
    /// </summary>
    public bool IsSteeringComplete
    {
        get => isSteeringComplete;
        set => isSteeringComplete = value;
    }
